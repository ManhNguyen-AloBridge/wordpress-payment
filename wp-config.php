...
// Keyword slug search payment price once
define('KEY_WORD_PRICE_ONCE','once');

// Keyword slug search payment price default
define('KEY_WORD_PRICE_DEFAULT','default');

// Value quantity default
define('VALUE_QUANTITY_DEFAULT',1);
